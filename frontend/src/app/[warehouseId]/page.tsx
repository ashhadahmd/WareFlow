...
const isDark = mounted && resolvedTheme === 'dark';
  ...
  const statCards = [
    { 
      ...
      icon: TrendingUp,
      positive: String(summary.total_revenue_change).startsWith('+')
    },
    { 
      ...
      icon: Package,
      positive: String(summary.inventory_value_change).startsWith('+')
    },
    { 
      ...
      icon: CheckCircle2,
      positive: String(summary.completed_orders_change).startsWith('+')
    },
    { 
      ...
      icon: Users,
      positive: String(summary.active_suppliers_change).startsWith('+')
    }
  ];
